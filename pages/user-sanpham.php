      ...
      <ul>
        ...
        <li>
          <div class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="./phan-loai.html?category_id=1">Cây dễ chăm</a>
              </li>
              <li>
                <a class="dropdown-item" href="./phan-loai.html?category_id=2">Cây văn phòng</a>
              </li>
              <li>
                <a class="dropdown-item" href="./phan-loai.html?category_id=3">Cây để bàn</a>
              </li>
              <li>
                <a class="dropdown-item" href="./phan-loai.html?category_id=4">Cây dưới nước</a>
              </li>
            </ul>
          </div>
        </li>
