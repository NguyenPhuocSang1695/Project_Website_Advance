...
<head>
    ...
    <!-- CSS  -->
    <link rel="stylesheet" type="text/css" href="../src/css/search-result.css" />
...
<body>
                                        ...
                                        <div class="filter-group">
                                            ...
                                            <div class="price-range-slider">
                                                ...
                                                <!-- <div class="price-ranges">
                                                    ...
                                                    <button type="button" class="price-preset"
                                                        onclick="setPrice(200000, 500000)">
                                                        200k - 500k
                                                    </button>
                                                    <button type="button" class="price-preset"
                                        ...
                                        <div class="filter-group">
                                            ...
                                            <div class="price-range-slider">
                                                ...
                                                <!-- <div class="price-ranges">
                                                    ...
                                                    <button type="button" class="price-preset"
                                                        onclick="setPriceMobile(200000, 500000)">
                                                        200k - 500k
                                                    </button>
                                                    <button type="button" class="price-preset"
                                                        onclick="setPriceMobile(500000, 1000000)">
                                                        500k - 1tr
                                                    </button>
                                                    <button type="button" class="price-preset"
    ...
    <section>
        <div class="loca">
            ...
            <span>></span>
            <a href="#"><span>Kết quả tìm kiếm</span></a>
        </div>
    ...
    <main>
        <div class="search-results-page">
            ...
            <div id="searchParams" class="search-params-container">
                <h3>Kết quả tìm kiếm cho: </h3>
                <ul class="search-params-list"></ul>
            </div>

            <div id="searchResults" class="search-results-container">
                <div class="error-message">
                    <i class="fas fa-exclamation-circle"></i>
                    <p>Có lỗi xảy ra khi tải kết quả tìm kiếm: Network response was not ok</p>
                </div>
            </div>



            <div class="pagination" id="pagination" style="display: flex; flex-direction: row; gap: 3px;"></div>
        </div>
    </main>
