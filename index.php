...
<body>
              ...
              <div id="offcanvasbody" class="offcanvas-body offcanvas-fullscreen mt-20">
                ...
                <div id="search-filter-container-mobile" class="search-filter-container-mobile">
                  <div class="filter-group">
                    ...
                    <select id="categoryFilter-mobile" class="form-select">
  ...
  <main>
    ...
    <section id="container_1" class="class">
      ...
      <!-- Anh -->
      <div class="IMG" onclick="window.location.href='./pages/phan-loai1.html';">
        <div class="img__TREE">
          <!-- LINK SẢN PHẨM -->
    ...
    <section id="product1" class="section-p1">
      ...
      <div class="pro-container">
        <div class="pro" onclick="window.location.href='user/user-san-pham1.html';">
        ...
        <div class="pro" onclick="window.location.href='user/user-san-pham2.html';">
        ...
        <div class="pro" onclick="window.location.href='./pages/phan-loai2.html';">
        ...
        <div class="pro" onclick="window.location.href='./pages/user-san-pham1.html';">
        ...
        <div class="pro" onclick="window.location.href='./pages/user-san-pham2.html';">
